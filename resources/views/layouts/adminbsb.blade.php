...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{asset('/home')}}" style="padding-top: 5px;"><img id="logo"
                                                                                             src="{{ asset('uploads/images/fit_'.$setting->logo) }}"
                                                                                             align="left"
                                                                                             style="height: 40px; margin-right: 5px;"><span
                        id="appname"
                        class="hidden-xs hidden-sm"> {{ $setting->appname }}<br><small>{!! $setting->subname !!}</small></span></a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info" id="fit_poster_image"
             style="background: url('{{ asset('uploads/images/posters/'.$poster) }}') no-repeat no-repeat; background-size: cover;">
            <div class="image">
                <img src="{{ asset('uploads/images/users/'.$photo) }}" width="48" height="48" alt="User"
                     id="fit_profile_photo"/>
            </div>
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true"
                     aria-expanded="false">{{ $user->fullname }}</div>
