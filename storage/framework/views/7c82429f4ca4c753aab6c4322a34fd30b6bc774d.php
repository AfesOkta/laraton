                            ...
                            <ol class="dd-list" id="listmenu">
                                ...
                                foreach ($__currentLoopData as $menu): $__env->incrementLoopIndices();
                                    ...
                                    <li class="dd-item dd3-item" data-id="<?php echo e($menu['id']); ?>">
                                        ...
                                        <div class="dd3-content"><a href="#" class="menulist" onclick="edit(this)"
                                                                    id="menu<?php echo e($menu['id']); ?>"
                                                                    data-id="<?php echo e($menu['id']); ?>"
                                                                    data-title="<?php echo e($menu['title']); ?>"
                                                                    data-url="<?php echo e($menu['url']); ?>"
                                                                    data-icon="<?php echo e($menu['icon']); ?>"><i
                                                        class="material-icons pull-left"><?php echo e($menu['icon']); ?></i>&nbsp;&nbsp;<?php echo e($menu['title']); ?>
                                            </a><a href="#" onclick="delete_menu(this)" class="pull-right"
                                                   data-id="<?php echo e($menu['id']); ?>"
                                                   data-title="<?php echo e($menu['title']); ?>">(hapus)</a></div>
                                        <?php list_menu($menu); ?>
                                    </li>
                                <?php endforeach;
                                $__env->popLoop();
                ...
                <div class="body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <button type="button" class="btn btn-default waves-effect pull-right" data-toggle="modal"
                                    data-target="#icons"><i class="material-icons" id="display-icon">help</i></button>
                            <div class="form-group">
                                <div class="form-line success">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('icons.materialicon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('style'); ?>
    <!-- JQuery Nestable Css -->
    <link href="<?php echo e(asset('template/adminbsb/plugins/nestable/jquery-nestable.css')); ?>" rel="stylesheet"/>
    <style type="text/css">
...
<?php $__env->startPush('script'); ?>
    <!-- Jquery Nestable -->
    <script src="<?php echo e(asset('template/adminbsb/plugins/nestable/jquery.nestable.js')); ?>"></script>
    <script type="text/javascript">
        ...
        var delete_menu = function (menu) {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(url('/menu/delete_menu')); ?>",
        ...
        $(function () {
            ...
            $('.dd').on('change', function () {
                ...
                $.ajax({
                    type: "POST",
                    data: {_token: '<?php echo e(csrf_token()); ?>', menus: serializedData},
                    url: "<?php echo e(url('/menu/sort_menu')); ?>",
                    success: function (data) {
                ...
                if (title == '' || icon == '' || url == '') {
                    ...
                    if (id > 0) {
                        $.ajax({
                            ...
                            url: "<?php echo e(url('/menu/update_menu')); ?>",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            data: {_token: '<?php echo e(csrf_token()); ?>', title: title, icon: icon, url: url},
                            url: "<?php echo e(url('/menu/add_menu')); ?>",
                            success: function (data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbsb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\PHP\laraton\laravel\resources\views/config/menu.blade.php ENDPATH**/ ?>
