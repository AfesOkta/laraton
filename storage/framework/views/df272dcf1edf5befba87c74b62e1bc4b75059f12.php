                ...
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="group-table">
                    ...
                    <tbody>
                    	...
                    	<tr>
                    		...
                    		<td><a onclick="fill_menu('<?php echo e($group->id); ?>', '<?php echo e($group->name); ?>');" style="cursor: pointer;" id="group<?php echo e($group->id); ?>"><?php echo e($group->name); ?></a></td>
                    		<td align="center"><a href="#" title="edit" onclick="edit_group('<?php echo e($group->id); ?>', '<?php echo e($group->name); ?>')"><i class="glyphicon glyphicon-pencil"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" title="hapus" onclick="delete_group('<?php echo e($group->id); ?>', '<?php echo e($group->name); ?>')"><i class="glyphicon glyphicon-trash"></i></a></td>
                    	</tr>
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        ...
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="checkbox" value="<?php echo e($menu['id']); ?>" id="menu<?php echo e($menu['id']); ?>" class="chk-col-green filled-in checkbox-group" name="menu"/>
                            <label for="menu<?php echo e($menu['id']); ?>" class="checkbox_menu level0"><?php echo e($menu['title']); ?></label>
...
<?php $__env->startPush('style'); ?>
    ...
    <link href="<?php echo e(asset('template/adminbsb/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbsb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laraton\resources\views/config/group.blade.php ENDPATH**/ ?>