...
?>
<head>
    <title>LANDING - <?php echo e(config('app.name')); ?></title>
    <meta charset="UTF-8">
    ...
    <link id="favicon" rel="icon" href="<?php echo e(asset('uploads/images/fav_' . $setting->logo)); ?>"
          type="image/x-icon">
    <link rel="stylesheet" href="<?php echo e(asset('template/hydro/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/hydro/css/magnific-popup.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('template/hydro/css/font-awesome.min.css')); ?>">

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('template/hydro/css/templatemo-style.css')); ?>">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="section-btn"><a href="<?php echo e(url('login')); ?>">Sign in / Join</a></li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="about-image">
                    <img src="<?php echo e(asset('template/hydro/images/about-image.jpg')); ?>" class="img-responsive"
                         alt="">
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="media blog-thumb">
                    <div class="media-object media-left">
                        <a href="blog-detail.html"><img
                                    src="<?php echo e(asset('template/hydro/images/blog-image1.jpg')); ?>"
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="media blog-thumb">
                    <div class="media-object media-left">
                        <a href="blog-detail.html"><img
                                    src="<?php echo e(asset('template/hydro/images/blog-image2.jpg')); ?>"
                                    class="img-responsive" alt=""></a>
                    </div>
                    <div class="media-body blog-info">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="media blog-thumb">
                    <div class="media-object media-left">
                        <a href="blog-detail.html"><img
                                    src="<?php echo e(asset('template/hydro/images/blog-image3.jpg')); ?>"
                                    class="img-responsive" alt=""></a>
                    </div>
                    <div class="media-body blog-info">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="media blog-thumb">
                    <div class="media-object media-left">
                        <a href="blog-detail.html"><img
                                    src="<?php echo e(asset('template/hydro/images/blog-image4.jpg')); ?>"
                                    class="img-responsive" alt=""></a>
                    </div>
                    <div class="media-body blog-info">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="work-thumb">
                    <a href="<?php echo e(asset('template/hydro/images/work-image1.jpg')); ?>" class="image-popup">
                        <img src="<?php echo e(asset('template/hydro/images/work-image1.jpg')); ?>"
            ...
            <div class="col-md-3 col-sm-6">
                <!-- WORK THUMB -->
                <div class="work-thumb">
                    <a href="<?php echo e(asset('template/hydro/images/work-image2.jpg')); ?>" class="image-popup">
                        <img src="<?php echo e(asset('template/hydro/images/work-image2.jpg')); ?>"
                             class="img-responsive" alt="Work">
            ...
            <div class="col-md-3 col-sm-6">
                <!-- WORK THUMB -->
                <div class="work-thumb">
                    <a href="<?php echo e(asset('template/hydro/images/work-image3.jpg')); ?>" class="image-popup">
                        <img src="<?php echo e(asset('template/hydro/images/work-image3.jpg')); ?>"
                             class="img-responsive" alt="Work">
            ...
            <div class="col-md-3 col-sm-6">
                <!-- WORK THUMB -->
                <div class="work-thumb">
                    <a href="<?php echo e(asset('template/hydro/images/work-image4.jpg')); ?>" class="image-popup">
                        <img src="<?php echo e(asset('template/hydro/images/work-image4.jpg')); ?>"
                             class="img-responsive" alt="Work">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8">
                ...
                <form id="contact-form" role="form" action="#" method="post">
                    <div class="col-md-6 col-sm-6">
                        <input type="text" class="form-control" placeholder="Full Name" id="cf-name" name="cf-name"
                               required="">
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <textarea class="form-control" rows="6" placeholder="Your requirements" id="cf-message"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li><a href="#sign_in" aria-controls="sign_in" role="tab" data-toggle="tab">Sign In</a>
                                </li>
                            </ul>
...
<!-- SCRIPTS -->
<script src="<?php echo e(asset('template/hydro/js/jquery.js')); ?>"></script>
<script src="<?php echo e(asset('template/hydro/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('template/hydro/js/jquery.stellar.min.js')); ?>"></script>
<script src="<?php echo e(asset('template/hydro/js/jquery.magnific-popup.min.js')); ?>"></script>
<script src="<?php echo e(asset('template/hydro/js/smoothscroll.js')); ?>"></script>
<script src="<?php echo e(asset('template/hydro/js/custom.js')); ?>"></script>

</body>
</html><?php /**PATH D:\Projects\PHP\laraton\laravel\resources\views/layouts/hydro.blade.php ENDPATH**/ ?>
