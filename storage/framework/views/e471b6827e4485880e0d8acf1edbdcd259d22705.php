        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group form-float">
                                <div class="form-line success">
                                    <input type="text" id="setting-appname" name="appname" class="form-control"
                                           value="<?php echo e($setting->appname); ?>" required="required">
                                    <label class="form-label" for="setting-appname">Nama Aplikasi <span class="col-red">*</span></label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line success">
                                    <input type="text" id="setting-subname" name="subname" class="form-control"
                                           value="<?php echo e($setting->subname); ?>" required="required">
                                    <label class="form-label" for="setting-subname">Sub Nama Aplikasi <span
                                                class="col-red">*</span></label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line success">
                                    <input type="text" id="setting-copyright" name="copyright" class="form-control"
                                           value="<?php echo e($setting->copyright); ?>" required="required">
                                    <label class="form-label" for="setting-copyright">Copyright <span
                                                class="col-red">*</span></label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line success">
                                    <input type="text" id="setting-version" name="version" class="form-control"
                                           value="<?php echo e($setting->version); ?>" required="required">
                                    <label class="form-label" for="setting-version">Versi <span class="col-red">*</span></label>
                                </div>
                            </div>
                            <label class="form-label" for="setting-skin">Default Skin <span
                                        class="col-red">*</span></label>
                            <div class="form-group form-float">
                                <div class="form-line success">
            ...
            <div class="card">
                <div class="header">
                    <div class="row clearfix">
                        <div class="col-xs-12 col-sm-6">
                            <h2>Default Background</h2><small>( <a href="<?php echo e(url('403')); ?>">403</a> / <a
                                        href="<?php echo e(url('404')); ?>">404</a> )</small>
                        </div>
                    </div>
                </div>
                <div class="body">
                    <div class="row">
                        <div class="col-xs-12 m-b-0">
                            <div class="image-content">
                                <div class="image-overlay overlay-bg">
                                    <div class="image-overlay-content"><img
                                                src="<?php echo e(asset('images/loader.gif')); ?>" alt="Loading..."/>
                                    </div>
                                </div>
                                <img src="<?php echo e(asset('uploads/images/' . $setting->bg)); ?>"
                                     class="img-responsive thumbnail" id="setting-bg"
                                     style="width: 100%; cursor: pointer;" data-toggle="modal" data-target="#bg-update">
                            </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row">
                        <div class="col-xs-12 m-b-0">
                            <div class="image-content">
                                <div class="image-overlay overlay-logo">
                                    <div class="image-overlay-content"><img
                                                src="<?php echo e(asset('images/loader.gif')); ?>" alt="Loading..."/>
                                    </div>
                                </div>
                                <img src="<?php echo e(asset('uploads/images/' . $setting->logo)); ?>"
                                     class="img-responsive thumbnail bg-striped" id="setting-logo"
                                     style="width: 100%; cursor: pointer;" data-toggle="modal"
                                     data-target="#logo-update">
                            </div>
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="row">
                        <div class="col-xs-12 m-b-0">
                            <div class="image-content">
                                <div class="image-overlay overlay-poster">
                                    <div class="image-overlay-content"><img
                                                src="<?php echo e(asset('images/loader.gif')); ?>" alt="Loading..."/>
                                    </div>
                                </div>
                                <img src="<?php echo e(asset('uploads/images/posters/' . $setting->poster)); ?>"
                                     class="img-responsive thumbnail" id="setting-poster"
                                     style="width: 100%; cursor: pointer;" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info waves-effect"
                            onclick="$('#input-logo').trigger('click');$('#logo-update').modal('hide');">Ganti Logo
                    </button>
                    <button type="button" class="btn btn-danger waves-effect pull-right" onclick="resetLogo();">Reset
                        Logo
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="poster-update" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info waves-effect"
                            onclick="$('#input-poster').trigger('click');$('#poster-update').modal('hide');">Ganti
                        Poster
                    </button>
                    <button type="button" class="btn btn-danger waves-effect pull-right" onclick="resetPoster();">Reset
                        Poster
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="bg-update" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info waves-effect"
                            onclick="$('#input-bg').trigger('click');$('#bg-update').modal('hide');">Ganti Background
                    </button>
                    <button type="button" class="btn btn-danger waves-effect pull-right" onclick="resetBg();">Reset
                    </button>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbsb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\PHP\laraton\laravel\resources\views/config/setting.blade.php ENDPATH**/ ?>
