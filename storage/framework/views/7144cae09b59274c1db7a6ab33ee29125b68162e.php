...
?>
    <div class="row clearfix">
        <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        <?php echo e(strtoupper($profile->fullname)); ?>
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#password-edit">Ganti
                                        password</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-xs-12 m-b-0">
                            <form id="uploadphoto" method="post" enctype="multipart/form-data">
                                <img src="<?php echo e(asset('uploads/images/users/' . $photo)); ?>"
                                     class="img-responsive thumbnail" id="profile_photo"
                                     style="width: 100%; cursor: pointer;" data-toggle="modal"
                                     data-target="#photo-update">
                                <input type="file" name="photo" id="photo" required style="display: none;"/>
                            </form>
                            <div class="profile-info">
                                <i class="icon fas fa-user col-black"></i><span
                                        id="p-name"><?php echo e($profile->name); ?></span><br>
                                <i class="icon fas fa-map-marker-alt col-cyan"></i><span
                                        id="p-address"><?php echo e($address); ?></span><br>
                                <i class="icon fas fa-envelope col-pink"></i><span
                                        id="p-email"><?php echo e($profile->email); ?></span><br>
                                <i class="icon fas fa-mobile col-orange"></i><span
                                        id="p-phone"><?php echo e($profile->phone); ?></span><br>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#social-input"
                                       onclick="reset_social();">Tambah Social Media</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="body">
                    <table width="100%" id="social-table">
                        <?php if (count($profile->socials) > 0): ?>
                            <?php $__currentLoopData = $profile->socials;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $social): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <tr data-id="<?php echo e($social->id); ?>">
                                    <td width="45"><a href="<?php echo e($social->link); ?>" target="_blank"><span
                                                    class="<?php echo e($social->icon); ?> socicon-icon"
                                                    style="background-color: <?php echo e($social->color); ?>;"></span></a>
                                    </td>
                                    <td><a href="<?php echo e($social->link); ?>"
                                           target="_blank"><?php echo e($social->name); ?></a></td>
                                    <td width="50"><a href="javascript:void(0);" title="edit"
                                                      onclick="edit_social('<?php echo e($social->id); ?>');"><i
                                                    class="fa fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                href="javascript:void(0);" title="hapus"
                                                onclick="remove_social('<?php echo e($social->id); ?>')"><i
                        ...
                        <?php else: ?>
                            <tr data-id="empty">
                                <td align="center"><i>Tidak ada data.</i></td>
                            </tr>
                        <?php endif; ?>
                    </table>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 m-b-0">
                            <form id="uploadposter" method="post" enctype="multipart/form-data">
                                <img src="<?php echo e(asset('uploads/images/posters/' . $poster)); ?>"
                                     class="img-responsive thumbnail" id="poster_image"
                                     style="width: 100%; cursor: pointer;" data-toggle="modal"
                                     data-target="#poster-update">
                ...
                <div class="body table-responsive">
                    <table class="table table-hover table-bordered table-striped" id="profile-table">
                        ...
                        <tr>
                            ...
                            <td data-column="name"><?php echo e($profile->name); ?></td>
                        </tr>
                        <tr>
                            <th>Nama Lengkap</th>
                            <td data-column="fullname"><?php echo e($profile->fullname); ?></td>
                        </tr>
                        <tr>
                            <th>Jenis Kelamin</th>
                            <td data-editable="false" data-toggle="modal" data-target="#gender-edit"
                                id="gender-column"><?php echo e(gender($profile->gender)); ?></td>
                        </tr>
                        <tr>
                            <th>Email</th>
                            <td data-column="email"><?php echo e($profile->email); ?></td>
                        </tr>
                        <tr>
                            <th>No. Telepon</th>
                            <td data-column="phone"><?php echo e($profile->phone); ?></td>
                        </tr>
                        <tr>
                            <th>Tempat Tanggal Lahir</th>
                            <td data-editable="false" data-toggle="modal" data-target="#birth-edit"
                                id="birth-column"><?php echo e($profile->birthplace . ', ' . fdate($profile->birthdate)); ?></td>
                        </tr>
                        <tr>
                            <?php $address = !empty($profile->village_id) ? address($profile->village_id) : ''; ?>
                            <th>Alamat</th>
                            <td data-editable="false" data-toggle="modal" data-target="#address-edit"
                                id="address-column"><?php echo e($profile->address . ' ' . $address . ' ' . $profile->postcode); ?></td>
                        </tr>
                        <tr>
                            <th>Tentang Pribadi</th>
                            <td data-column="about"><?php echo $profile->about; ?></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#education-input"
                                       onclick="reset_education();">Tambah Riwayat Pendidikan</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="body">
                    <table width="100%" id="education-table">
                        <?php if (count($profile->educations) > 0): ?>
                            <?php $__currentLoopData = $profile->educations;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $school): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <tr data-id="<?php echo e($school->id); ?>" valign="top">
                                    <td width="120"><strong><?php echo e($years); ?></strong></td>
                                    <td>
                                        <strong><?php echo e($school->name); ?></strong><br><small>Tingkat <?php echo e(education_levels($school->level) . $majors); ?></small><br><small>di <?php echo e($school->place); ?></small>
                                    </td>
                                    <td width="50"><a href="javascript:void(0);" title="edit"
                                                      onclick="edit_education('<?php echo e($school->id); ?>');"><i
                                                    class="fa fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                href="javascript:void(0);" title="hapus"
                                                onclick="remove_education('<?php echo e($school->id); ?>')"><i
                                                    class="fa fa-trash"></i></a></td>
                                </tr>
                            <?php endforeach;
                            $__env->popLoop();
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#work-input"
                                       onclick="reset_work();">Tambah Riwayat Pekerjaan</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="body">
                    <table width="100%" id="work-table">
                        <?php if (count($profile->works) > 0): ?>
                            <?php $__currentLoopData = $profile->works;
                            $__env->addLoop($__currentLoopData);
                            foreach ($__currentLoopData as $work): $__env->incrementLoopIndices();
                                $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <tr data-id="<?php echo e($work->id); ?>" valign="top">
                                    <td width="120"><strong><?php echo e($years); ?></strong></td>
                                    <td><strong><?php echo e($name); ?></strong><?php echo $position; ?>
                                        <br><small>di <?php echo e($work->place); ?></small></td>
                                    <td width="50"><a href="javascript:void(0);" title="edit"
                                                      onclick="edit_work('<?php echo e($work->id); ?>');"><i
                                                    class="fa fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                href="javascript:void(0);" title="hapus"
                                                onclick="remove_work('<?php echo e($work->id); ?>')"><i
                                                    class="fa fa-trash"></i></a></td>
                                </tr>
                            <?php endforeach;
                            $__env->popLoop();
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-link waves-effect" data-dismiss="modal"
                            onclick="resetFormPassword();">TUTUP
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="gender-edit" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo e(Form::select('gender', ['m' => 'Laki-laki', 'f' => 'Perempuan'], $profile->gender, ['class' => 'form-control show-tick', 'id' => 'gender'])); ?>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="birthplace" name="birthplace" class="form-control"
                                   value="<?php echo e($profile->birthplace); ?>">
                        </div>
                    </div>
                    <label class="form-label">Tanggal Lahir <span class="col-red">*</span></label>
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" class="datepicker form-control" id="birthdate"
                                   placeholder="Please choose a date..."
                                   value="<?php echo e(fdate($profile->birthdate)); ?>">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 m-b-15">
                            ...
                            <?php echo e(Form::select('province_id', [null => 'Pilih Provinsi'] + provinces(), !empty($profile->village_id) ? $profile->village->district->regency->province->id : null, ['class' => 'form-control show-tick', 'id' => 'provinces', 'onChange' => 'getRegencies(this.value);'])); ?>

                        </div>
                        <div class="col-md-6 m-b-15">
                            <label class="form-label">Kota/Kabupaten</label>
                            <?php echo e(Form::select('regency_id', !empty($profile->village_id) ? regencies($profile->village->district->regency->province->id) : [null => 'Pilih Kota/Kabupaten'], !empty($profile->village_id) ? $profile->village->district->regency->id : null, ['class' => 'form-control show-tick', 'id' => 'regencies', 'onChange' => 'getDistricts(this.value);'])); ?>

                        </div>
                        <div class="col-md-6 m-b-15">
                            <label class="form-label">Kecamatan</label>
                            <?php echo e(Form::select('district_id', !empty($profile->village_id) ? districts($profile->village->district->regency->id) : [null => 'Pilih Kecamatan'], !empty($profile->village_id) ? $profile->village->district->id : null, ['class' => 'form-control show-tick', 'id' => 'districts', 'onChange' => 'getVillages(this.value);'])); ?>

                        </div>
                        <div class="col-md-6 m-b-15">
                            <label class="form-label">Kelurahan/Desa <span class="col-red">*</span></label>
                            <?php echo e(Form::select('village_id', !empty($profile->village_id) ? villages($profile->village->district->id) : [null => 'Pilih Kelurahan/Desa'], !empty($profile->village_id) ? $profile->village->id : null, ['class' => 'form-control show-tick', 'id' => 'villages'])); ?>
                        ...
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Alamat"
                                              id="address"><?php echo $profile->address; ?></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info waves-effect"
                            onclick="$('#photo').trigger('click');$('#photo-update').modal('hide');">Ganti Foto
                    </button>
                    <button type="button" class="btn btn-danger waves-effect pull-right" onclick="removePhoto();">Hapus
                        Foto
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="poster-update" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <button type="button" class="btn btn-info waves-effect"
                            onclick="$('#poster').trigger('click');$('#poster-update').modal('hide');">Ganti Poster
                    </button>
                    <button type="button" class="btn btn-danger waves-effect pull-right" onclick="removePoster();">Hapus
                        Poster
                    </button>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            ...
                            <label for="social-icon">Icon <span class="col-red">*</span></label><a
                                    class="waves-effect pull-right" data-toggle="modal" data-target="#socicon"
                                    id="display-icon"><span class="socicon-internet socicon-icon"
                                                            style="background-color: black;"></span></a>
                            <div class="form-group">
                                <div class="form-line success">
    ...
    <div class="modal fade" id="socicon" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <?php echo $__env->make('icons.socicon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
                    ...
                    <div class="row clearfix">
                        <form id="education-form">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="form-line success">
                                        <?php echo e(Form::select('education-level', [null => '--Pilih Tingkat--'] + education_levels(), null, ['class' => 'form-control show-tick', 'id' => 'education-level'])); ?>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="form-line success">
                                        <?php echo e(Form::select('education-status', [null => '--Status Sekarang--', 'yes' => 'Masih Belajar', 'no' => 'Sudah Keluar'], null, ['class' => 'form-control show-tick', 'id' => 'education-status'])); ?>
                    ...
                    <div class="row clearfix">
                        <form id="work-form">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group m-b-0">
                                    <div class="form-line success">
                                        <?php echo e(Form::select('work-status', [null => '--Status Sekarang--', 'yes' => 'Masih Bekerja', 'no' => 'Sudah Berhenti'], null, ['class' => 'form-control show-tick', 'id' => 'work-status'])); ?>
...
<?php $__env->startPush('style'); ?>
    ...
    <link href="<?php echo e(asset('template/adminbsb/plugins/bootstrap-select/css/bootstrap-select.css')); ?>"
          rel="stylesheet"/>
    ...
    <link href="<?php echo e(asset('ext/fontawesome-iconpicker/dist/css/fontawesome-iconpicker.min.css')); ?>"
          rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(asset('template/adminbsb/plugins/editable-table/mindmup-editabletable.js')); ?>"></script>

    <!-- Moment Plugin Js -->
    <script src="<?php echo e(asset('template/adminbsb/plugins/momentjs/moment-with-locales.js')); ?>"></script>

    <!-- Autosize Plugin Js -->
    <script src="<?php echo e(asset('template/adminbsb/plugins/autosize/autosize.js')); ?>"></script>

    <!-- Bootstrap Material Datetime Picker Plugin Js -->
    <script src="<?php echo e(asset('template/adminbsb/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>"></script>

    <!-- Fontawesome Iconpicker -->
    <script src="<?php echo e(asset('ext/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.js')); ?>"></script>

    <script type="text/javascript">
        var getRegencies = function (province_id) {
            $.get('<?php echo e(url("information")); ?>/create/ajax-regencies?province_id=' + province_id, function (data) {
                $('#regencies').html(data);
        ...
        var getDistricts = function (regency_id) {
            $.get('<?php echo e(url("information")); ?>/create/ajax-districts?regency_id=' + regency_id, function (data) {
                $('#districts').html(data);
        ...
        var getVillages = function (district_id) {
            $.get('<?php echo e(url("information")); ?>/create/ajax-villages?district_id=' + district_id, function (data) {
                $('#villages').html(data);
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#profile_photo').attr('src', "<?php echo e(asset('uploads/images/users')); ?>/" + data.photo);
                        $('#fit_profile_photo').attr('src', "<?php echo e(asset('uploads/images/users')); ?>/fit_" + data.photo);
                    },
                    error: function (data) {
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#poster_image').attr('src', "<?php echo e(asset('uploads/images/posters')); ?>/poster.jpg");
                        $('#fit_poster_image').css('background', "url('<?php echo e(asset('uploads/images/posters')); ?>/fit_poster.jpg");
        ...
        function remove_social(sid) {
            swal({
                ...
                $.ajax({
                    ...
                    data: {_token: '<?php echo e(csrf_token()); ?>', id: sid},
                    type: 'POST',
                    success: function (data) {
                        swal("Berhasil!", data, "success");
        ...
        function edit_social(sid) {
            $.ajax({
                type: "POST",
                data: {_token: '<?php echo e(csrf_token()); ?>', id: sid},
                url: "<?php echo e(url('/profile/get_social')); ?>",
                dataType: "json",
                success: function (data) {
                    console.log(data);
                    $('#social-id').val(sid);
            ...
            if (name == '' || icon == '' || link == '') {
                ...
                if (id > 0) {
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/update_social')); ?>",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/add_social')); ?>",
                        success: function (data) {
        ...
        function edit_education(sid) {
            $.ajax({
                type: "POST",
                data: {_token: '<?php echo e(csrf_token()); ?>', id: sid},
                url: "<?php echo e(url('/profile/get_education')); ?>",
                dataType: "json",
                success: function (data) {
                    console.log(data);
            ...
            if (name == '' || level == '' || place == '' || year_in == '' || status == '') {
                ...
                if (id > 0) {
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/update_education')); ?>",
                        success: function (data) {
                            showAlert(data.message, 'bg-blue');
                            var years = year_in;
                            if (year_out) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/add_education')); ?>",
                        success: function (data) {
                            showAlert(data.message, 'bg-blue');
                            var years = year_in;
                            if (year_out) {
        ...
        function edit_work(sid) {
            $.ajax({
                type: "POST",
                data: {_token: '<?php echo e(csrf_token()); ?>', id: sid},
                url: "<?php echo e(url('/profile/get_work')); ?>",
                dataType: "json",
                success: function (data) {
                    console.log(data);
                    $('#work-id').val(sid);
            ...
            if (name == '' || place == '' || year_in == '' || status == '') {
                ...
                if (id > 0) {
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/update_work')); ?>",
                        success: function (data) {
                            showAlert(data, 'bg-blue');
                            var years = year_in;
                            if (year_out) {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(url('/profile/add_work')); ?>",
                        success: function (data) {
                            showAlert(data.message, 'bg-blue');
                            var years = year_in;
                            if (year_out) {
        ...
        function updateData(column, newValue) {
            $.ajax({
                url: 'profile/update',
                data: {_token: '<?php echo e(csrf_token()); ?>', column: column, value: newValue},
                type: 'POST',
                success: function (data) {
                    showAlert(data, 'bg-blue');
            ...
            swal({
                ...
                if (village_id && address && postcode) {
                    if (postcode.length == 5) {
                        ...
                        $.ajax({
                            url: 'profile/address',
                            data: {_token: '<?php echo e(csrf_token()); ?>', village_id: village_id},
                            type: 'POST',
                            dataType: 'json',
                            success: function (data) {
            ...
            swal({
                ...
                if (old_password && new_password && confirm_password) {
                    if (new_password === confirm_password) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(url('/profile/password')); ?>",
                            dataType: 'json',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
            ...
            $('#photo').on('change', function () {
                ...
                if (!isImage(ext)) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        success: function (data) {
                            $('#profile_photo').attr('src', "<?php echo e(asset('uploads/images/users')); ?>/" + data.photo + "?" + new Date().getTime());
                            $('#fit_profile_photo').attr('src', "<?php echo e(asset('uploads/images/users')); ?>/fit_" + data.photo + "?" + new Date().getTime());
                            showAlert(data.message, 'bg-blue');
                        },
                        error: function (data) {
                            showAlert('Error: ' + data, 'bg-red');
            ...
            $('#poster').on('change', function () {
                ...
                if (!isImage(ext)) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        success: function (data) {
                            $('#poster_image').attr('src', "<?php echo e(asset('uploads/images/posters')); ?>/" + data.poster + "?" + new Date().getTime());
                            $('#fit_poster_image').css('background', "url('<?php echo e(asset('uploads/images/posters')); ?>/fit_" + data.poster + "?" + new Date().getTime());
                            $('#fit_poster_image').css('background-size', 'cover');
                            showAlert(data.message, 'bg-blue');
                        },
                        error: function (data) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.adminbsb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\PHP\laraton\laravel\resources\views/config/profile.blade.php ENDPATH**/ ?>
